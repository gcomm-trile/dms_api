...
namespace albus_api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class DashboardNVBHController : ControllerBase
    {
        private readonly ILogger<DashboardNVBHController> _logger;

        public DashboardNVBHController(ILogger<DashboardNVBHController> logger)
        {
            _logger = logger;
        }
